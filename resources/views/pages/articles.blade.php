...
{{--                            <add-cart-component :product-id="{{json_encode($article->id)}}" :product-name="{{json_encode($article->title)}}" :product-description="{{json_encode($article->short_description)}}"></add-cart-component>--}}
